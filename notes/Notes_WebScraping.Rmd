...
Often times you will see data posted on the web (in a Wikepedia page, etc.) but it may not be readily available to download as a .csv file. You can use the `rvest` packages to "scrape" the information from the web and import it into R. 
